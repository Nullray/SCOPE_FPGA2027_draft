...
topology or translate guest DMA addresses and device semantics.
...
should not require a different DUT interface or bitstream. \sys does not attempt
to reproduce a physical PCIe link: it validates the system-software and device
interaction above the link layer, not PHY, LTSSM, DLLP, or electrical behavior.
