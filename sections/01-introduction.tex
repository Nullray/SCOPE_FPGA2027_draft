...
\begin{itemize}[leftmargin=*]
    ...
    control overhead, and data-path performance. FPGA resource scaling and
    simultaneous multi-device operation are identified as experiments rather
    than reported results until their measurement records are complete.
\end{itemize}
